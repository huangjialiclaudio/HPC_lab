...
**WARNING:** you have to substitute `/path/to/host/folder` with the actual name of the path on your laptop, for instance `/home/matteo/polimi/amsc23-24/shared-folder` or `~/shared-folder` on MAC
